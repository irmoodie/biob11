...
Here we will walk through the steps of installing R and RStudio on your own device.
...
Note that the homebrew version of R is not supported by CRAN, and as such any package that used C/C++/Fortran code (which a lot of R packages do) will require you to have the appropriate compiler installed. For that reason, unless you know what you are doing, I do not recommend it.
...
I suggest you borrow a laptop from the IT department. If you really want to try using your own device, there are a few options:

### Using webRios

WebRios is a native iPadOS app that runs a WebAssembly version of R. I have no way to test this out, sorry, but it looks promising! You can find it on the [App Store](https://apps.apple.com/se/app/webrios/id6758071087).
...
WebRoid is a native Android app that runs a WebAssembly version of R. I have tested it, sorry, but it looks promising! You can find it on the [Play Store](https://play.google.com/store/apps/details?id=com.webroid.app).
...
![A screenshot of a new RStudio installation on macOS.](images/rstudio_3.png)
