...
Follow the [guide](install_r.qmd) on how to install R and RStudio on your computer. Once they're both installed, return
to this section.
...
Can you figure out how to recreate one of the plots from the [first exercise](exercises/01_eda.qmd)? Once you have, you
should upload a screenshot of your RStudio as the [assignment](https://canvas.education.lu.se/courses/39432/assignments)
